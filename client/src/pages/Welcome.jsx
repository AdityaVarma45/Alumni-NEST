  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fadeUp">
              ...
              <div className="mt-8 flex gap-4">
                ...
                <Link
                  to="/register"
                  className="bg-blue-600 text-white px-7 py-3 rounded-lg hover:bg-blue-700 transition shadow-md"
                >
                  Join AlumniNest
                </Link>
        ...
        {/* ================= CTA ================= */}
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center bg-blue-600 rounded-2xl text-white p-12 shadow-xl">
